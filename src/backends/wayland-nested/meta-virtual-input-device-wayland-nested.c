...
get_pointer_source (MetaVirtualInputDeviceWaylandNested *self)
{
  ...
  if (META_IS_SEAT_WAYLAND_NESTED (self->seat))
    return meta_seat_wayland_nested_peek_pointer (META_SEAT_WAYLAND_NESTED (self->seat));
...
get_keyboard_source (MetaVirtualInputDeviceWaylandNested *self)
{
  ...
  if (META_IS_SEAT_WAYLAND_NESTED (self->seat))
    return meta_seat_wayland_nested_peek_keyboard (META_SEAT_WAYLAND_NESTED (self->seat));
               ...
               ClutterButtonState         button_state)
{
  ...
  clutter_button = evdev_to_clutter_button (evdev_button);
