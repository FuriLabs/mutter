...
G_DEFINE_TYPE (MetaKeymapWaylandNested,
...
create_default_keymap (void)
{
  ...
  names.variant = option_xkb_variant && *option_xkb_variant ? option_xkb_variant : NULL;
  names.options = option_xkb_options && *option_xkb_options ? option_xkb_options : NULL;
