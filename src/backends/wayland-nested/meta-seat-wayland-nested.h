...
ClutterInputDevice * meta_seat_wayland_nested_peek_pointer (MetaSeatWaylandNested *self);
ClutterInputDevice * meta_seat_wayland_nested_peek_keyboard (MetaSeatWaylandNested *self);
